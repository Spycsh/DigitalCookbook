...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `CookBook`.`CookBook` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `CookBook`.`preparation_step` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `CookBook`.`DefaultNotAllowedPair` ;
...
CREATE TABLE IF NOT EXISTS `CookBook`.`DefaultNotAllowedPair` (
  ...
  PRIMARY KEY (`DefaultNotAllowedPair_id`))
ENGINE = InnoDB;
